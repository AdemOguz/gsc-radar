(function () {
  ...
  var dictionary = {
    tr: {
      ...
      "home.promo_title": "GSC Radar ile SEO performansinizi olc, yorumla ve hizla buyut.",
      "home.promo_desc": "GSC ve GA4 verilerini tek ekranda birlestiren GSC Radar; saglik takibi, keyword intelligence, growth tools ve white-label raporlama ile ekiplerine net aksiyon ve olculebilir buyume sunar.",
      "home.promo_start": "Hemen Basla",
      "home.promo_open_sample": "Ornek Aylik Raporu Ac",
      "home.promo_kpi_1_value": "7/24",
      "home.promo_kpi_1_label": "Canli SEO saglik takibi",
      "home.promo_kpi_2_value": "Tek Akis",
      "home.promo_kpi_2_label": "Analiz + Aksiyon + Raporlama",
      "home.promo_kpi_3_value": "White-label",
      "home.promo_kpi_3_label": "Musteriye hazir premium cikti",
      "home.proof_1_value": "7/24",
      "home.proof_1_label": "Otomatik izleme ve alarm akislari",
      "home.proof_2_value": "Tek Panel",
      "home.proof_2_label": "GSC + GA4 + Growth Tools yonetimi",
      "home.proof_3_value": "Aksiyon",
      "home.proof_3_label": "Veriden direkt uygulanabilir gorevlere gecis",
      "home.proof_4_value": "White-label",
      "home.proof_4_label": "Musteriye hazir markali rapor ciktilari",
      "home.acq_title": "Musteri kazanmak icin rapor degil, sonuc goster.",
      "home.acq_desc": "GSC Radar ile her ay ayni hikayeyi degil, olculebilir ilerlemeyi sunarsin: kayiplar, firsatlar, cozum aksiyonlari ve net etki beklentisi tek akista.",
      "home.acq_start_trial": "14 Gunluk Denemeyi Baslat",
      "home.acq_live_demo": "Canli Demoya Gec",
      "home.acq_review_report": "Rapor Ornegini Incele",
      "home.visual_login": "Google + Uye Girisi",
      "home.visual_site": "Property Aktivasyonu",
      "home.visual_health": "Skor + Trend + Alarm",
      ...
      "monthly.preflight_title": "Aylik rapor oncesi tavsiye edilen adimlar",
      "monthly.preflight_note": "Bu adimlari tamamlamak, eksik veri ile rapor paylasma riskini azaltir.",
      "monthly.preflight_badge": "Rapor Kalitesi Kontrolu",
      "monthly.preflight_item_1": "<strong>Dogru siteyi secin:</strong> Raporu olusturmadan once dogru proje/domain secildigini kontrol edin.",
      "monthly.preflight_item_2": "<strong>Rapor ayini netlestirin:</strong> Ay seciminden sonra donemin tamamlandigindan emin olun.",
      "monthly.preflight_item_3": "<strong>Veri cekimini yenileyin:</strong> Once ilgili ekranlarda \"verileri cek/guncelle\" islemini yapin.",
      "monthly.preflight_item_4": "<strong>Alarm ve saglik durumunu kontrol edin:</strong> Kritik uyari varken rapor paylasmadan once not dusun.",
      "monthly.preflight_item_5": "<strong>Not ekleyin:</strong> Bu aya ozel durumlari (kampanya, teknik degisiklik, sezon etkisi) rapora yazin.",
      "monthly.preflight_item_6": "<strong>Marka ayarlarini tamamlayin:</strong> Musteri adi, raporu hazirlayan ve logo bilgisini doldurun.",
      "monthly.preflight_item_7": "<strong>Son kontrol yapin:</strong> KPI kartlari, hikaye modu ve aksiyon plani bolumlerinin dolu oldugunu teyit edin.",
      "monthly.preflight_tip": "Ipucu: Veri eksikse once \"Raporu Getir\" ile sayfayi yenileyin, sonra PDF olusturun.",
    ...
    en: {
      ...
      "home.promo_title": "Measure, interpret, and scale SEO performance faster with GSC Radar.",
      "home.promo_desc": "GSC Radar unifies GSC and GA4 data on one screen, giving your teams clear actions and measurable growth with health tracking, keyword intelligence, growth tools, and white-label reporting.",
      "home.promo_start": "Start Now",
      "home.promo_open_sample": "Open Sample Monthly Report",
      "home.promo_kpi_1_value": "24/7",
      "home.promo_kpi_1_label": "Live SEO health monitoring",
      "home.promo_kpi_2_value": "Single Flow",
      "home.promo_kpi_2_label": "Analysis + Action + Reporting",
      "home.promo_kpi_3_value": "White-label",
      "home.promo_kpi_3_label": "Client-ready premium output",
      "home.proof_1_value": "24/7",
      "home.proof_1_label": "Automated monitoring and alert flows",
      "home.proof_2_value": "Single Panel",
      "home.proof_2_label": "Manage GSC + GA4 + Growth Tools together",
      "home.proof_3_value": "Action",
      "home.proof_3_label": "Move from data to executable tasks instantly",
      "home.proof_4_value": "White-label",
      "home.proof_4_label": "Branded client-ready report outputs",
      "home.acq_title": "Win clients by proving outcomes, not just reporting.",
      "home.acq_desc": "With GSC Radar, you deliver measurable progress every month: losses, opportunities, action plans, and expected impact in one clear flow.",
      "home.acq_start_trial": "Start 14-Day Trial",
      "home.acq_live_demo": "Open Live Demo",
      "home.acq_review_report": "Review Report Sample",
      "home.visual_login": "Google + Member Login",
      "home.visual_site": "Property Activation",
      "home.visual_health": "Score + Trend + Alerts",
      ...
      "monthly.preflight_title": "Recommended Steps Before Monthly Report",
      "monthly.preflight_note": "Completing these steps reduces the risk of sharing reports with missing data.",
      "monthly.preflight_badge": "Report Quality Check",
      "monthly.preflight_item_1": "<strong>Select the correct site:</strong> Confirm the right project/domain before generating the report.",
      "monthly.preflight_item_2": "<strong>Confirm the report month:</strong> Make sure the selected period is complete.",
      "monthly.preflight_item_3": "<strong>Refresh data collection:</strong> Run data fetch/update actions on relevant screens first.",
      "monthly.preflight_item_4": "<strong>Check alerts and health:</strong> If critical alerts exist, add a note before sharing.",
      "monthly.preflight_item_5": "<strong>Add context notes:</strong> Include campaign, technical changes, or seasonal effects for this month.",
      "monthly.preflight_item_6": "<strong>Complete branding details:</strong> Fill in client name, report owner, and logo info.",
      "monthly.preflight_item_7": "<strong>Run final check:</strong> Verify KPI cards, story mode, and action plan sections are populated.",
      "monthly.preflight_tip": "Tip: If data is incomplete, click \"Load Report\" first, then generate the PDF.",
